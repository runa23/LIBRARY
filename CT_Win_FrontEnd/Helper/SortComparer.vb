...
#End Region
    Private Function CompareValues(ByVal xValue As Object, ByVal yValue As Object, ByVal direction As ListSortDirection) As Integer
        ...
        If xValue IsNot Nothing OrElse yValue IsNot Nothing Then
            If xValue IsNot Nothing AndAlso TypeOf xValue Is IComparable Then
                ...
                End If
            Else
                If yValue IsNot Nothing AndAlso TypeOf yValue Is IComparable Then
